...
<div class="modal-header ">
    <h5 class="modal-title"><i class="flaticon2-crisp-icons"></i> Төрийн албаны ангилал</h5>
        					...
        					<div class="kt-portlet__head-actions">
        						<div class="btn-group" role="group">
                                	...
                                	<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                		<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#regModal" data-id="<?=$_id?>" data-url="<?=RF;?>/m/reference/form/add_pet_organ"><i class="la la-edit"></i> Үндсэн мэдээлэл засах</a>
                                	</div>
                                </div>
							</div>
        				</div>
                            				...
                            				<table class="table table-striped font-12">
                            					<tbody>
                            						<tr>
                            							...
                            							<td><?=$mainObj->ClassTitle?></td>
                            						</tr>
                            						<tr>
                            							<td class="color-gray" nowrap>Эрэмбэ: </td>
                            							<td><?=$mainObj->ClassOrder?></td>
                            						</tr>
                            						<tr>
                            							<td class="color-gray" nowrap>Идэвхитэй эсэх:</td>
                            							<td><?=$mainObj->ClassIsShow?"Тийм":"Үгүй";?></td>
                            						</tr>
