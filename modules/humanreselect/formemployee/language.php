...
?>
<form class="kt-form kt-form--label-right" id="felonyFormAdmin" action="<?=RF;?>/process/humanreselect/<?=$_paramid>0?"updatelanguage":"addlanguage"?>" enctype="multipart/form-data">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-danger mr-auto" id="delete" data-url="<?=RF;?>/process/humanreselect/removelanguage">Устгах</button>
 	<?php }?>
