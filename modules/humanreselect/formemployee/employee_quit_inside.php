...
?>
<form class="kt-form kt-form--label-right" id="letterForm" action="<?=RF;?>/process/humanreselect/transferemployee" enctype="multipart/form-data">
            ...
            <div class="row">
				<div class="col-lg-6 form-group">
    				...
    				<select class="form-control kt-input form-control-sm ajax_select" data-col-index="6" name="employee_start[EmployeeDepartmentID]" 
    					data-url="<?=RF;?>/m/ajax/select?notid=<?=$personObj->EmployeePositionID?>" 
