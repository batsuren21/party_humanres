<?php
    ...
    foreach ($_resultList as $j => $row){
        ...
        $btn='<a href="javascript:;" class="btn btn-primary btn-elevate btn-icon btn-sm" title="Дэлгэрэнгүй" data-id="'.$tmpObj->RefHolidayID.'" data-toggle="modal" data-target="#detailModal" data-url="'.RF.'/m/humanreselect/form_holiday/detail">
