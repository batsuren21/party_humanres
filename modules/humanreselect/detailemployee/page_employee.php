		...
		<div class="kt-portlet kt-portlet-noneshadow mt-3 portlets" data-ktportlet="true" id="kt_portlet_tools_1">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">Үүрийн бүртгэл</h3>
				</div>
			</div>
                    	...
                    	<div class="col-lg-12">
                    		<div class="row">
                    			<div class="col">
                                    ...
                                    <tr>
                                    	<th width="1%" >#</th> 
                                    	<th width="20%">Үүрийн нэр</th>
                                    	<th width="20%">Бүртгэсэн байдал</th> 
                                    	<th width="20%">Бүртгэсэн огноо</th> 
                                    	<th width="30%">Хассан байдал</th>
                                    	<th width="20%">Хассан огноо</th>
                            		</tr>
                                    </thead>
                                    <tbody>
                                    <?php 
