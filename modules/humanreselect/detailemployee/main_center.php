					...
					<div class="kt-portlet__head-actions">
						...
						<div class="btn-group" role="group">
                        	...
                        	<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        		<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#regModal" data-id="<?=$personObj->PersonID?>" data-url="<?=RF;?>/m/humanreselect/form/edit_person"><i class="la la-edit"></i> Хувь хүний мэдээлэл засах</a>
                        		<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#regModal" data-url="<?=RF;?>/m/humanreselect/form/edit_person_contact" data-id="<?=$personObj->PersonID?>"><i class="fa fa-address-book"></i> Холбоо барих мэдээлэл засах</a>
                    			<?php if($_priv_reg){?>
                    			<?php if($personObj->EmployeeIsActive){?>
                    			<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#detailSubModal" data-url="<?=RF;?>/m/humanreselect/formemployee/employee_start_edit" data-id="<?=$personObj->PersonID?>" data-paramid="<?=$personObj->PersonEmployeeID?>"><i class="la la-edit"></i> Үүрийн бүртгэл засах</a>
                    			<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#detailSubModal" data-url="<?=RF;?>/m/humanreselect/formemployee/employee_quit" data-id="<?=$personObj->PersonID?>" data-paramid="<?=$personObj->PersonEmployeeID?>"><i class="la la-edit"></i> Үүрээс хасах</a>
                    		
                    			<?php }else{?>
                    			<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#detailSubModal" data-url="<?=RF;?>/m/humanreselect/formemployee/employee_quit" data-id="<?=$personObj->PersonID?>" data-paramid="<?=$personObj->PersonEmployeeID?>"><i class="la la-edit"></i> Үүрээс хассан мэдээлэл засах</a>
                    			<?php }?>
                    			<?php }?>
                    		</div>
                        </div>
