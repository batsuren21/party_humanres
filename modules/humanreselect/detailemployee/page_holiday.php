			...
			<div class="kt-portlet__head">
				...
				<div class="kt-portlet__head-toolbar ">
					<div class="kt-portlet__head-group">
						<a href="javascript:;" data-toggle="modal" data-target="#detailSubModal" data-url="<?=RF;?>/m/humanreselect/formemployee/holiday" data-id="<?=$_id?>" data-paramid='0' class="btn btn-brand btn-sm btn-icon-md">
                    			...
                    			<div class="col">
                                    ...
                                    <tr>
                                    	<td nowrap="nowrap" rowspan="2">
                                    		<?=$j?>.
                                    		<?php if($_priv_reg){?>
                                    		<br><a href="javascript:;" class="btn btn-primary btn-elevate btn-icon btn-sm" title="засах" data-id="<?=$personObj->PersonID?>" data-paramid='<?=$tmpObj->HolidayID?>' data-toggle="modal" data-target="#detailSubModal" data-url="<?=RF;?>/m/humanreselect/formemployee/holiday">
                                                <i class="la la-edit"></i>
                                            </a>
                                    		<?php }?> 
                                    		<a href="javascript:;" data-target="#detailPrintModalHumanres" 
                                    			data-toggle="modal" 
                                    			data-url="<?=RF?>/m/humanreselect/list/json_holiday?id=<?=$tmpObj->HolidayID?>" 
