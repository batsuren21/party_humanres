    		...
    		<div class="col-lg-9">
    			<div class="row">
        			...
        			<?php 
            			...
            			}elseif(isset($_GET['_spage']) && file_exists(DRF.'/modules/humanreselect/detailemployee/page_'.$_GET['_spage'].".php")){
            			    require_once DRF.'/modules/humanreselect/detailemployee/page_'.$_GET['_spage'].".php";
            			}
                    ?>
                	</div>
                </div>
