<?php
    ...
    Office\System::$custom_js[]=RF."/assets/js/module/humanres/report/index.js";
        					...
        					<div class="col-lg-12 text-center">
        						<div class="dropdown dropdown-inline">
        							...
        							<div class="dropdown-menu dropdown-menu-right">
        								<a class="dropdown-item download_excel" href="javascript:;" data-url="<?=RF;?>/m/humanres/export/workdays_excel1">
        									1. Улсад ажилласан жил
    									</a>
        								<a class="dropdown-item download_excel" href="javascript:;" data-url="<?=RF;?>/m/humanres/export/workdays_excel2">
        									2. Төрд ажилласан жил
    									</a>
        								<a class="dropdown-item download_excel" href="javascript:;" data-url="<?=RF;?>/m/humanres/export/workdays_excel3">
        									3. Аж ахуйн нэгжид ажилласан жил
    									</a>
        								<a class="dropdown-item download_excel" href="javascript:;" data-url="<?=RF;?>/m/humanres/export/workdays_excel4">
        	...
        	<div class="kt-portlet kt-portlet--mobile">
        		...
        		<div class="kt-portlet__body ">
        			<div class="card-body search_body" id="search">
        				...
        				<div class="row ">
        					<div class="col-lg-12 text-center">
								<button type="button" class="btn btn-brand btn-elevate btn-icon-sm download_excel" data-url="<?=RF;?>/m/humanres/export/workdays_employee_excel">
        	...
        	<div class="kt-portlet kt-portlet--mobile">
        		...
        		<div class="kt-portlet__body ">
        			<div class="card-body search_body" id="search">
        				...
        				<div class="row ">
        					<div class="col-lg-12 text-center">
								<button type="button" class="btn btn-brand btn-elevate btn-icon-sm download_excel" data-url="<?=RF;?>/m/humanres/export/award_excel">
        							<i class="la la-download"></i> Тайлан татах 
        						</button>
    						</div>
        				</div>
        	...
        	<div class="kt-portlet kt-portlet--mobile">
        		...
        		<div class="kt-portlet__body ">
        			<div class="card-body search_body" id="search">
        				...
        				<div class="row ">
        					<div class="col-lg-12 text-center">
								<button type="button" class="btn btn-brand btn-elevate btn-icon-sm download_excel" data-url="<?=RF;?>/m/humanres/export/award_employee_excel">
        							<i class="la la-download"></i> Тайлан татах 
        						</button>
    						</div>
        				</div>
        	...
        	<div class="kt-portlet kt-portlet--mobile">
        		...
        		<div class="kt-portlet__body ">
        			<div class="card-body search_body" id="search">
        				...
        				<div class="row ">
        					<div class="col-lg-12 text-center">
								<button type="button" class="btn btn-brand btn-elevate btn-icon-sm download_excel" data-url="<?=RF;?>/m/humanres/export/study_employee_excel">
        							<i class="la la-download"></i> Тайлан татах 
        						</button>
    						</div>
        				</div>
