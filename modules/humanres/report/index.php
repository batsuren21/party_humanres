...
$_priv_access=\Office\Permission::getPriv(\Office\PrivClass::PRIV_HUMANRES_REPORT);
...
if($_priv_access){
    ...
    echo \Office\System::getPage("error/nopriv",["title"=>"","descr"=>"Танд өргөдөл, гомдол бүртгэх эрх байхгүй байна"]);
}
