<?php
    ...
    foreach ($_resultList as $j => $row){
        ...
        $btn='<a href="javascript:;" class="btn btn-primary btn-elevate btn-icon btn-sm" title="Дэлгэрэнгүй" data-id="'.$positionObj->PositionID.'" data-toggle="modal" data-target="#detailModal" data-url="'.RF.'/m/humanres/detail/position">
        ...
        $data[]=array(
            ...
            $classObj->RefClassTitle." ".$rankObj->RefRankTitle,
            $degreeObj->RefDegreeTitle,
