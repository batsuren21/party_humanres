<?php
    ...
    Office\System::$custom_js[]=RF."/assets/js/module/humanres/position/index.js";
					...
					<?php 
					   if($_priv_reg){?>
						<button type="button" class="btn btn-brand btn-elevate btn-icon-sm" data-toggle="modal" data-target="#regModal" 
							data-id="0"
							data-url="<?=RF;?>/m/humanres/form/add_position">
		...
		<div class="kt-portlet__body">
					...
					<div id="collapseOne4" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample4">
						<div class="card-body" id="search">
							<div class="row kt-margin-b-20">
            					...
            					<div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
            						<label class="font-12">Зэрэглэл:</label>
            						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[position_rankid]">
            							<?php \System\Combo::getCombo(["data"=>$_rankList,"title"=>"RefRankTitle","value"=>"RefRankID","flag"=>\System\Combo::SELECT_ALL,"selected"=>-1])?>
            						</select>
            					</div>
            					<div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
            						<label class="font-12">Төрөл:</label>
            						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[position_typeid]">
            							<?php \System\Combo::getCombo(["data"=>$_typeList,"title"=>"RefTypeTitle","value"=>"RefTypeID","flag"=>\System\Combo::SELECT_ALL,"selected"=>-1])?>
            						</select>
            					</div>
            				</div>
            				<div class="row kt-margin-b-20">
            					<div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
            						<label class="font-12">Зэрэг дэв:</label>
            						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[position_degreeid]">
            							<?php \System\Combo::getCombo(["data"=>$_degreeList,"title"=>"RefDegreeTitle","value"=>"RefDegreeID","flag"=>\System\Combo::SELECT_ALL,"selected"=>-1])?>
            						</select>
            					</div>
            				</div>
			...
			<thead>
				<tr>
					...
					<th class="text-center" width="1%">Ангилал, зэрэглэл</th>
					<th class="text-center">Зэрэг дэв</th>
