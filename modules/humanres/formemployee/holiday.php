...
?>
<form class="kt-form kt-form--label-right" id="felonyFormAdmin" action="<?=RF;?>/process/humanres/<?=$_paramid>0?"updateholiday":"addholiday"?>" enctype="multipart/form-data">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-danger mr-auto" id="delete" data-url="<?=RF;?>/process/humanres/removeholiday">Устгах</button>
 	<?php }?>
