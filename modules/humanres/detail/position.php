...
<div class="modal-header ">
    <h5 class="modal-title"><i class="flaticon2-crisp-icons"></i> Албан тушаал</h5>
        					...
        					<div class="kt-portlet__head-actions">
        						<div class="btn-group" role="group">
                                	...
                                	<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                		<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#regModal" data-id="<?=$_id?>" data-url="<?=RF;?>/m/humanres/form/edit_position"><i class="la la-edit"></i> Үндсэн мэдээлэл засах</a>
                                	</div>
                                </div>
							</div>
        				</div>
                            			...
                            			<div class="col">
                            				<table class="table table-striped font-12">
                            					<tbody>
                            						...
                            						<tr>
                            							<td class="color-gray" nowrap width="1%">Албан тушаалын товч нэр: </td>
                            							<td><?=$positionObj->PositionName?></td>
                            						</tr>
                            						<tr>
                            							<td class="color-gray" nowrap>Албан тушаалын нэр: </td>
                            						...
                            						<tr>
                            							<td class="color-gray" nowrap>Зэрэглэл: </td>
                            							<td><?=$_rankObj->RefRankTitle;?></td>
                            						</tr>
                            						<tr>
                            						...
                            						<tr>
                            							<td class="color-gray" nowrap>Зэрэг дэв: </td>
                            							<td><?=$_degreeObj->RefDegreeTitle;?></td>
                            						</tr>
                            						<tr>
                            							<td class="color-gray">Орон тоо:</td>
                            							<td><?=$positionObj->PositionCountPerson;?></td>
                            						</tr>
                            						<tr>
