...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel2" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist" data-url="<?=RF;?>/m/humanres_list/list/list2">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Сургуулийн төрөл</th>
					<th class="text-center font-12" nowrap width="100">Боловсролын түвшин</th>
					<th class="text-center font-12" nowrap width="100">Боловсролын зэрэг</th>
					<th class="text-center font-12" nowrap width="100">Сургуулийн нэр</th>
					<th class="text-center font-12" nowrap width="100">Элссэн огноо</th>
					<th class="text-center font-12" nowrap width="100">Одоо сурч байгаа эсэх</th>
					<th class="text-center font-12" nowrap width="100">Төгссөн огноо</th>
					<th class="text-center font-12" nowrap width="100">Гэрчилгээ, дипломын дугаар</th>
					<th class="text-center font-12" nowrap width="100">Мэргэжил</th>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[education_schoolid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_schoolList,"title"=>"RefSchoolTitle","value"=>"RefSchoolID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
            			</select>
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[education_levelid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_levelList,"title"=>"RefLevelTitle","value"=>"RefLevelID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
    					</select>
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[education_degreeid]">
					...
					<th class="text-center" ><input type="text" name="searchdata[education_schooltitle]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" nowrap>
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[education_startdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[education_startdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[education_isnow]">
					...
					<th class="text-center" nowrap>
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[education_enddatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[education_enddateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" ><input type="text" name="searchdata[education_licence]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ><input type="text" name="searchdata[education_profession]" class="form-control kt-input form-control-sm"></th>
				</tr>
			</tfoot>
			</table>
			</div>
