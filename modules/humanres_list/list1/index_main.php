...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel1" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist"  data-url="<?=RF;?>/m/humanres_list/list/list1">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="40">Ургийн овог</th>
					...
					<th class="text-center font-12" nowrap width="100">Боловсрол</th>
					<th class="text-center font-12" nowrap> Яс үндэс</th>
					<th class="text-center font-12" nowrap> Төрсөн аймаг, нийслэл</th>
					<th class="text-center font-12" nowrap> Төрсөн сум, дүүрэг</th>
					<th class="text-center font-12" nowrap> Хаяг / аймаг, нийслэл /</th>
					<th class="text-center font-12" nowrap> Хаяг / сум, дүүрэг /</th>
					<th class="text-center font-12" nowrap> Цэргийн алба хаасан эсэх</th>
					<th class="text-center font-12" nowrap> Цэргийн үүрэгтний үнэмлэх №</th>
					<th class="text-center font-12" nowrap> Алба хаасан он</th>
					<th class="text-center font-12" nowrap> Алба хаасан байдал</th>
					<th class="text-center font-12" nowrap> Улсад ажилласан жил</th>
					<th class="text-center font-12" nowrap> Төрд ажилласан жил</th>
					<th class="text-center font-12" nowrap> Цэргийн албанд ажилласан жил</th>
					<th class="text-center font-12" nowrap> Аж ахуй нэгжид ажилласан жил</th>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" ></th>
					<th class="text-center" ><input type="text" name="searchdata[person_middlename]" class="form-control kt-input form-control-sm"></th>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[person_educationlevelid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_eduLevelList,"title"=>"RefLevelTitle","value"=>"RefLevelID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
            			</select>
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[person_ethnicid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_ethnicList,"title"=>"RefEthnicTitle","value"=>"RefEthnicID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
    					</select>
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[person_birthcityid]">
							<?php \System\Combo::getCombo(["data"=>$_areaList,"title"=>"AreaName","value"=>"AreaID","flag"=>\System\Combo::SELECT_SINGLE,'selected'=>""])?>
                		</select>
					</th>
					<th class="text-center"></th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[person_addresscityid]">
							<?php \System\Combo::getCombo(["data"=>$_areaList,"title"=>"AreaName","value"=>"AreaID","flag"=>\System\Combo::SELECT_SINGLE,'selected'=>""])?>
                		</select>
					</th>
					<th class="text-center" ></th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " name="searchdata[person_issoldering]" >
					...
					<th class="text-center" ><input type="text" name="searchdata[person_soldierpassno]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ><input type="text" name="searchdata[person_soldieryear]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[person_soldierid]">
						    <?php \System\Combo::getCombo(["data"=>$_soldierList,"title"=>"RefSoldierTitle","value"=>"RefSoldierID","flag"=>\System\Combo::SELECT_SINGLE,'selected'=>""])?>
    					</select>
					</th>
					<th class="text-center"></th>
					<th class="text-center"></th>
