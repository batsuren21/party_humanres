...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel3" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist" data-url="<?=RF;?>/m/humanres_list/list/list3">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Сургалтын чиглэл</th>
					<th class="text-center font-12" nowrap width="100">Улс</th>
					<th class="text-center font-12" nowrap width="100">Сургалтын байгууллагын нэр</th>
					<th class="text-center font-12" nowrap width="100">Сургалтын нэр, сэдэв</th>
					...
					<th class="text-center font-12" nowrap width="100">Тайлбар</th>
					<th class="text-center font-12" nowrap width="100">Үнэмлэх, гэрчилгээний дугаар</th>
					<th class="text-center font-12" nowrap width="100">Олгосон огноо</th>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[study_directionid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_directionList,"title"=>"RefDirectionTitle","value"=>"RefDirectionID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
            			</select>
					</th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[study_countryid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_countryList,"title"=>"CountryName","value"=>"CountryID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
    					</select>
					</th>
					<th class="text-center" ><input type="text" name="searchdata[study_schooltitle]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ><input type="text" name="searchdata[study_title]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" nowrap>
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[study_startdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[study_startdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" nowrap>
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[study_enddatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[study_enddateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" ></th>
					<th class="text-center" ><input type="text" name="searchdata[study_licence]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ></th>
				</tr>
			</tfoot>
			</table>
