...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel13" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist" data-url="<?=RF;?>/m/humanres_list/list/list13">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Дугаар</th>
					<th class="text-center font-12" nowrap width="100">Ээлжийн амралтын жил</th>
					<th class="text-center font-12" nowrap width="100">Амрах хоног</th>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" ><input type="text" name="searchdata[holiday_regnumber]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" >
					</th>
					<th class="text-center" >
					</th>
					<th class="text-center" >
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[holiday_datestart1]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[person_datestart2]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" >
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[holiday_dateend1]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[person_dateend2]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
				</tr>
			</tfoot>
			</table>
