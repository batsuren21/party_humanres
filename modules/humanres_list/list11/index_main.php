...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel11" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist" data-url="<?=RF;?>/m/humanres_list/list/list11">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Харилцааны төрөл</th>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[relation_relationid]"  >
					...
					<th class="text-center" ><input type="text" name="searchdata[relation_lastname]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ><input type="text" name="searchdata[relation_firstname]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm" data-col-index="2" name="searchdata[relation_jobtypeid]">
							<?php \System\Combo::getCombo(["data"=>$_jobList,"title"=>"RefTypeTitle","value"=>"RefTypeID","flag"=>\System\Combo::SELECT_SINGLE,'selected'=>""])?>
                		</select>
					</th>
					<th class="text-center" ><input type="text" name="searchdata[relation_joborgan]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" ><input type="text" name="searchdata[relation_jobposition]" class="form-control kt-input form-control-sm"></th>
