...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet ">
				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="javascript:;" class="btn btn-brand btn-elevate btn-icon-sm download_excel" 
    						data-url="<?=RF?>/m/humanres_list/export/excel8" 
		...
		<div class="kt-portlet__body" id="search">
			...
			<table class="table  table-bordered table-hover " id="mainlist" data-url="<?=RF;?>/m/humanres_list/list/list8">
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Сахилгын шийтгэлийн төрөл</th>
					<th class="text-center font-12" nowrap width="100">Хугацаа</th>
					<th class="text-center font-12" nowrap width="100">Хувь</th>
					...
					<th class="text-center font-12" nowrap width="100">Үндэслэл</th>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[punishment_refid]"  >
            				<?php \System\Combo::getCombo(["data"=>$_punishmentList,"title"=>"RefPunishmentTitle","value"=>"RefPunishmentID","flag"=>\System\Combo::SELECT_SINGLE,"selected"=>""])?>
            			</select>
					</th>
					<th class="text-center" ></th>
					<th class="text-center" ></th>
					<th class="text-center" ><input type="text" name="searchdata[punishment_order]" class="form-control kt-input form-control-sm"></th>
					<th class="text-center" >	
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[punishment_orderdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[punishment_orderdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" ></th>
				</tr>
			</tfoot>
