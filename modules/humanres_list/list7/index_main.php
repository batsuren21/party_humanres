		...
		<div class="kt-portlet__body" id="search">
			...
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Байгууллагын төрөл</th>
					<th class="text-center font-12" nowrap width="100">Байгууллагын ангилал</th>
					<th class="text-center font-12" nowrap width="100">Байгууллагын дэд ангилал</th>
					<th class="text-center font-12" nowrap width="100">Байгууллагын нэр</th>
					<th class="text-center font-12" nowrap width="100">Газар, хэлтэс, алба</th>
					<th class="text-center font-12" nowrap width="100">Албан тушаал</th>
					<th class="text-center font-12" nowrap width="100">Одоо ажиллаж байгаа эсэх</th>
					<th class="text-center font-12" nowrap width="100">Ажилд орсон огноо</th>
					<th class="text-center font-12" nowrap width="100">Ажлаас гарсан огноо</th>
					<th class="text-center font-12" nowrap width="100">Ажилд орсон тушаалын дугаар</th>
					<th class="text-center font-12" nowrap width="100">Чөлөөлөгдсөн үндэслэл</th>
					<th class="text-center font-12" nowrap width="100">Чөлөөлөгдсөн тушаалын дугаар</th>
					<th class="text-center font-12" nowrap width="100">Чөлөөлөгдсөн тушаалын огноо</th>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
            		...
            		<th class="text-center" >	
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_startdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_startdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					<th class="text-center" >	
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_quitdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_quitdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
					...
					<th class="text-center" >	
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_quitorderdatestart]"  placeholder="Эхлэх огноо" data-col-index="5" />
						<input type="text" class="form-control kt-input  form-control-sm font-12 datepicker" style="width: 75px;" name="searchdata[job_quitorderdateend]" placeholder="Дуусах огноо" data-col-index="5" />
					</th>
				</tr>
			</tfoot>
			</table>
