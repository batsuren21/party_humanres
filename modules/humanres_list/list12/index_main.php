		...
		<div class="kt-portlet__body" id="search">
			...
			<thead>
				<tr>
					...
					<th class="text-center font-12" nowrap width="100">Үндсэн цалин</th>
					<th class="text-center font-12" nowrap width="100">Зэрэг дэвийн нэмэгдэл</th>
					<th class="text-center font-12" nowrap width="100">Онцгой нөхцлийн нэмэгдэл</th>
					<th class="text-center font-12" nowrap width="100">Эрдмийн зэрэг, цолны нэмэгдэл</th>
				</tr>
				<tr>
				...
				<tr>
					...
					<th class="text-center" >
						<select class="form-control kt-input form-control-sm " data-col-index="2" name="searchdata[salary_conditionid]"  >
            				...
            				<option value="0"> --- Нэмэгдэл байхгүй ---</option>
