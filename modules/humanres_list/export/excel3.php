...
$array_header=array(
    ...
    array('title'=>"Сургалтын чиглэл","type"=>"Direction",'width'=>15),
    array('title'=>"Улс","type"=>"Country",'width'=>15),
    array('title'=>"Сургалтын байгууллагын нэр","value"=>"StudySchoolTitle",'width'=>15),
    array('title'=>"Сургалтын нэр, сэдэв","value"=>"StudyTitle",'width'=>20),
    array('title'=>"Элссэн огноо","value"=>"StudyDateStart",'width'=>10),
    array('title'=>"Төгссөн огноо","value"=>"StudyDateEnd",'width'=>10),
    array('title'=>"Тайлбар","value"=>"StudyDescr",'width'=>20),
    array('title'=>"Үнэмлэх, гэрчилгээний дугаар","value"=>"StudyLicence",'width'=>20),
    array('title'=>"Олгосон огноо","value"=>"StudyLicenceDate",'width'=>20),  
);
    ...
    for($jj=0; $jj<count($array_header); $jj++){
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                ...
                }elseif($array_header[$jj]['type']=='Direction'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_directionObj->RefDirectionTitle);
                }elseif($array_header[$jj]['type']=='Country'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_countryObj->CountryName);
                }
            }
        }
    }
