...
$array_header=array(
    ...
    array('title'=>"Томилолтын төрөл","type"=>"Ref",'width'=>30),
    array('title'=>"Эхлэх огноо","value"=>"TripDateStart",'width'=>15),
    array('title'=>"Дуусах огноо","value"=>"TripDateEnd",'width'=>20),
    array('title'=>"Тушаал шийдвэрийн дугаар","value"=>"TripOrder",'width'=>20),
    array('title'=>"Тушаал шийдвэрийн огноо","value"=>"TripOrderDate",'width'=>15),
);
        ...
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                if($array_header[$jj]['type']=='Num'){
                    ...
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_refObj->RefTripTitle);
                }
            }
        }
    }
