...
$array_header=array(
    ...
    array('title'=>"Бүртгэсэн огноо","value"=>"HolidayCreateDate",'width'=>15),
    ...
    array('title'=>"Дугаар","value"=>"HolidayRegisterNumberFull",'width'=>10),
    array('title'=>"Ээлжийн амралтын жил","type"=>"jobdate",'width'=>30),
    array('title'=>"Амрах хоног","value"=>"HolidayDays",'width'=>20),
    array('title'=>"Эхлэх огноо","value"=>"HolidayDateStart",'width'=>20),
    array('title'=>"Дуусах  огноо","value"=>"HolidayDateEnd",'width'=>20),
);
    ...
    for($jj=0; $jj<count($array_header); $jj++){
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                ...
                }elseif($array_header[$jj]['type']=='jobdate'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $tmpMainObj->HolidayJobDateStart." - ".$tmpMainObj->HolidayJobDateEnd);
                }
            }
        }
    }
