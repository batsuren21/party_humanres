...
$array_header=array(
    ...
    array('title'=>"Гэр бүлийн гишүүн","type"=>"Relation",'width'=>20),
    array('title'=>"Эцэг, эхийн нэр","value"=>"FamilyLastName",'width'=>15),
    array('title'=>"Өөрийн нэр","value"=>"FamilyFirstName",'width'=>20),
    array('title'=>"Төрсөн огноо","value"=>"FamilyBirthDate",'width'=>20),
    array('title'=>"Төрсөн газар","type"=>"BirthCity",'width'=>20),
    array('title'=>"Төрсөн газар /сум, дүүрэг/","type"=>"BirthDistrict",'width'=>20),
    array('title'=>"Хөдөлмөр эрхлэлтийн байдал","type"=>"JobType",'width'=>20),
    array('title'=>"Байгууллагын нэр","value"=>"FamilyJobOrgan",'width'=>20),
    array('title'=>"Албан тушаал","value"=>"FamilyJobPosition",'width'=>20),
);
    ...
    for($jj=0; $jj<count($array_header); $jj++){
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                ...
                }elseif($array_header[$jj]['type']=='Relation'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_relationObj->RefRelationTitle);
                }elseif($array_header[$jj]['type']=='BirthCity'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_cityObj->AreaName);
                }elseif($array_header[$jj]['type']=='BirthDistrict'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_districtObj->AreaName);
                }elseif($array_header[$jj]['type']=='JobType'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_jobObj->RefTypeTitle);
                }
            }
        }
    }
