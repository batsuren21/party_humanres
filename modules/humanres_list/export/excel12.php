...
$array_header=array(
    ...
    array('title'=>"Үндсэн цалин","value"=>"SalaryValue",'width'=>30),
    array('title'=>"Зэрэг дэвийн нэмэгдэл","type"=>"Degree",'width'=>15),
    array('title'=>"Онцгой нөхцлийн нэмэгдэл","type"=>"Condition",'width'=>20),
    array('title'=>"Эрдмийн зэрэг, цолны нэмэгдэл","type"=>"Edu",'width'=>20),
);
    ...
    for($jj=0; $jj<count($array_header); $jj++){
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                ...
                }elseif($array_header[$jj]['type']=='Condition'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $tmpMainObj->SalaryConditionID>0?$_condObj->RefConditionTitle:"Нэмэгдэлгүй");
                }elseif($array_header[$jj]['type']=='Edu'){
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $tmpMainObj->SalaryEduID>0?$_eduObj->RefEduTitle:"Нэмэгдэлгүй");
                }
            }
        }
    }
