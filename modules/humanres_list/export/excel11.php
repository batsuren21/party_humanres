...
$array_header=array(
    ...
    array('title'=>"Харилцааны төрөл","type"=>"Relation",'width'=>20),
    array('title'=>"Эцэг, эхийн нэр","value"=>"RelationLastName",'width'=>15),
    array('title'=>"Өөрийн нэр","value"=>"RelationFirstName",'width'=>20),
    array('title'=>"Хөдөлмөр эрхлэлтийн байдал","type"=>"JobType",'width'=>20),
    array('title'=>"Байгууллагын нэр","value"=>"RelationJobOrgan",'width'=>20),
    array('title'=>"Албан тушаал","value"=>"RelationJobPosition",'width'=>20),
);
