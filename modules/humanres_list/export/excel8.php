...
$array_header=array(
    ...
    array('title'=>"Сахилгын шийтгэлийн төрөл","type"=>"Ref",'width'=>30),
    array('title'=>"Хугацаа","value"=>"PunishmentTime",'width'=>15),
    array('title'=>"Хувь","value"=>"PunishmentPercent",'width'=>20),
    array('title'=>"Тушаал шийдвэрийн дугаар","value"=>"PunishmentOrder",'width'=>20),
    array('title'=>"Тушаал шийдвэрийн огноо","value"=>"PunishmentOrderDate",'width'=>15),
    array('title'=>"Үндэслэл","value"=>"PunishmentReason",'width'=>20),
);
        ...
        if(isset($array_header[$jj]['value'])){
            ...
            if(isset($array_header[$jj]['type'])){
                if($array_header[$jj]['type']=='Num'){
                    ...
                    $activesheet->setCellValueByColumnAndRow($jj, $i, $_refObj->RefPunishmentTitle);
                }
            }
        }
    }
